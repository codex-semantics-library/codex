...
module Bitvector_Backward = struct
  ...
  let bimul_add ~size ~prod ~offset _ = assert false
...
module Bitvector_Forward = Bitvector_Backward
module Binary_Backward = Bitvector_Backward
module Binary_Forward = Bitvector_Forward

module Enum_Backward = struct
  let caseof ~case _ = assert false
  let enum_const ~case = assert false
end
module Enum_Forward = Enum_Backward
