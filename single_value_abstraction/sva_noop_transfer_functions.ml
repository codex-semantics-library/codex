...
module Bitvector_Backward = struct
  ...
  let bisub ~size ~flags _ _ _  = warn_once "bisub"; (None,None)
  let bimul ~size ~flags _ _ _  = warn_once "bimul"; (None,None)
  ...
  let bshl ~size ~flags _ _ _  = warn_once "bshl"; (None,None)
